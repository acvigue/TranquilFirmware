...
class RestAPIRobot
{
  ...
  public:
    ...
    void apiGetLEDConfig(String &reqStr, String &respStr);
    void apiPostLEDConfig(String &reqStr, String &respStr);
    void apiPostSettingsBody(String& reqStr, uint8_t *pData, size_t len, size_t index, size_t total);
    void apiPostLEDConfigBody(String& reqStr, uint8_t *pData, size_t len, size_t index, size_t total);
